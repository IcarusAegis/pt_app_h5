<template>
  <main class="screen v3-layout">
    ...
    <section class="workspace v3-workspace">
      <!-- Home View -->
      ...
      <!-- QR View -->
      <section v-else-if="viewState === 'qr'" class="scan-panel v3-scan-panel">
        <div class="qr-nav">
        ...
        <div class="scan-stage v3-scan-stage">
