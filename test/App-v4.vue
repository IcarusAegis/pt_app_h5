<template>
  <main class="screen v4-layout">
    ...
    <section class="workspace v4-workspace">
      <!-- Home View -->
      <div v-if="viewState === 'home'" class="home-view">
        <div class="home-heading">
          <p>科创器材共享柜</p>
          <h1 class="home-title">请选择所需服务</h1>
        </div>
        <div class="home-actions">
          <button class="btn-massive btn-take" @click="goToQr('borrow')">
          ...
          <button class="btn-massive btn-store" @click="goToQr('return')">
        ...
        <div class="home-status-strip" :class="'home-status-strip--' + connectionTone">
          <span></span>
      ...
      <!-- QR View -->
      <section v-else-if="viewState === 'qr'" class="scan-panel v4-scan-panel">
        <div class="qr-nav">
        ...
        <div class="scan-copy qr-heading">
          <div>
        ...
        <div class="scan-stage v4-scan-stage">
          ...
          <aside class="action-panel">
            <div class="metric-row">
              ...
              <div>
                <span>服务器连接</span>
                <strong :style="{ color: wsConnected ? '#10b981' : '#ef4444' }">{{ wsConnected ? '已连接' : '未连接' }}</strong>
              </div>
            </div>
